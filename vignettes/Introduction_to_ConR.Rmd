...
locs <- locations.comp(occs[, c(1:3),],  method = "fixed_grid",
                            nbe_rep = 30,
                            cell_size_locations = 10, 
                            Rel_cell_size = 0.05, 
                            #protec.areas = strict.ucs.spdf, 
                            #ID_shape_PA= "NAME",
...
critB <- cat_criterion_b(EOO = EOO,
                                  AOO = AOO,
                                  locations = nbe_loc_total,
