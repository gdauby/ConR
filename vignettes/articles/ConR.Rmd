...
<<<<<<< HEAD:vignettes/articles/ConR.Rmd


<!-- CHECK HERE: Gilles, je fait etape par etape car criterionB me renvoy un error :
=======
<!-- CHECK HERE: Gilles, j'ai fait etape par etape car la fonction criterion_B() me renvoy un error :
>>>>>>> devel:vignettes/ConR.Rmd
...
pop_metrics <- criterion_B(x = occs, method.range = "convex.hull", show_progress = FALSE)

```

<!-- So far criterion_B do not wrapp AOH   ?? -->
