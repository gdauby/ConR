...
<img src="IUCN_results_map/IUCN_Berlinia_bruneelii.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="MyIUCNresults_results_map/MyIUCNresultsBerlinia_bruneelii.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="loc1_results_map/loc1Anodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="loc2_results_map/loc2Anodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
```
<img src="loc3_results_map/loc3Anodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="slide_results_map/slideAnodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="protec_results_map/protecAnodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>
...
<img src="protec2_results_map/protec2Anodonthyla_moramora.png" alt="Drawing" title="Example of a map output exported in IUCN_results_map directory " style="width: 600px;"/>

**Note 1:**
Only a map of protected areas from Madagascar is included in ConR, as an example dataset. If you want to import your own protected area shapefile, you can do it by using the function [```readOGR```](https://www.rdocumentation.org/packages/rgdal/versions/1.4-8/topics/readOGR). Protected area shapefile can be freely dowloaded from the World Database on Protected Areas (WDPA, http://www.protectedplanet.net/).
