...
#         ext <-
#           terra::ext(
#             floor(Corners[1, 1]) - h * (size * 1000 / 4) - 20 * size * 1000,
#             floor(Corners[1, 2]) + h * (size * 1000 / 4) + 20 *
#               size * 1000,
#             floor(Corners[2, 1]) - h * (size * 1000 / 4) - 20 *
#               size * 1000,
#             floor(Corners[2, 2]) + h * (size * 1000 / 4) + 20 *
#               size * 1000
#           )
#         
#         r <-
